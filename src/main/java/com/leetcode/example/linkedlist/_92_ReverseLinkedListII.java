...
public class _92_ReverseLinkedListII {
    public static void main(String[] args) {
        if (true) {
            ...
            int m = 2;
            int n = 4;
            System.out.println(s.reverseBetween(head, m, n).show()); //1->4->3->2->5
        }
        ...
        if (true) {
            ...
            int m = 1;
            int n = 1;
            System.out.println(s.reverseBetween(head, m, n).show()); //5
        }
        ...
        if (true) {
            ...
            int m = 3;
            int n = 3;
            System.out.println(s.reverseBetween(head, m, n).show()); //1->2->3
        }
        ...
        if (true) {
            ...
            int m = 3;
            int n = 4;
            System.out.println(s.reverseBetween(head, m, n).show()); //1->2->4->3->5
        }
        ...
        if (true) {
            ...
            int m = 1;
            int n = 2;
            System.out.println(s.reverseBetween(head, m, n).show()); //5->3
        }
    }
