...
public class _684_RedundantConnection {
    public static void main(String[] args) {
        if (true) {
            ...
            System.out.println("Result " + Arrays.toString(s.findRedundantConnection(edges))); //[2, 3]
        }
        ...
        if (true) {
            ...
            System.out.println("Result " + Arrays.toString(s.findRedundantConnection(edges))); //[1, 4]
        }
